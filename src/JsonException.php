 ...
 */
class JsonException extends RuntimeException implements Exceptable {
  use exceptableTrait;
  ...
  const INFO = [
    ...
    JSON_ERROR_UTF8 => ['message' => 'malformed UTF-8 characters, possibly incorrectly encoded'],
    ...
    JSON_ERROR_UTF16 => ['message' => 'malformed UTF-16 characters, possibly incorrectly encoded']
  ];

  /** @see exceptableTrait::_makeCode() */
  protected function _makeCode() : int {
    return json_last_error();
  }

  /** @see exceptableTrait::_makeMessage() */
