...
interface Observable extends \SplSubject {
   ...
   * triggers are either regular expressions (sans delimiters+flags) or literal strings.
   ...
   * to replace the existing list instead, pass TRUE as the third arg.
   *
   ...
   * in addition:
   *
   * to remove specific triggers, pass them (in an array) as the second arg;
   * otherwise the observer is removed.
   *
